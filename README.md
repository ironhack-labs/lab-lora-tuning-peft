...
Create environment WITH the yml file
conda env create -f environment.yml
...
The repository’s file structure looks like following:  .
├── README.md
├── app.py
├── data
│   └── amazon_reviews_backup
...
you can access the blog post by:
...
# Opening your browser and navigate to:
http://localhost:5000
```
